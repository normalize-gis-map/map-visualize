  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-950 px-4 py-8 sm:px-6 lg:px-8">
      ...
      <section className="relative grid w-full max-w-6xl overflow-hidden rounded-[2rem] border border-white/15 bg-slate-950/65 shadow-[0_45px_120px_-40px_rgba(2,132,199,0.6)] backdrop-blur-2xl lg:grid-cols-[1.05fr_0.95fr]">
        <div className="relative hidden min-h-[620px] flex-col justify-between border-b border-white/10 p-8 lg:flex lg:border-r lg:border-b-0 lg:p-10">
          ...
          <div className="relative z-10">
            ...
            <h1 className="mt-4 max-w-md text-4xl leading-tight font-semibold text-white xl:text-5xl">
          ...
          <div className="relative z-10 rounded-3xl border border-cyan-100/15 bg-slate-950/55 p-5 backdrop-blur-xl">
            <div className="mb-4 flex items-center gap-2 text-[11px] font-semibold tracking-[0.16em] text-cyan-200/85 uppercase">
              Live map preview
            </div>
            <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-slate-900 via-slate-950 to-blue-950 p-4">
        ...
        <div className="relative min-h-[560px] p-4 sm:p-6 lg:p-8">
          <LoginForm />
        </div>
      </section>
    </main>
